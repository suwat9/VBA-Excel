Sub Arabic2Thai()
    ...
    'Code แสดงตัวอย่างการใช้งาน บรรทัดด้านล่างทั้งหมดลบทิ้งได้ ยกเว้น End Sub ห้ามลบ
    'การเลือกตำแหน่งเซลที่ต้องการเปลี่ยนจากเลขอาระบิคเป็นเลขไทย ในตัวอย่างเลือก A1
    Range("A1").Select
